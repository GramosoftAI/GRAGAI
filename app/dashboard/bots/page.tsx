...
//   // const { setAgentList: setAgents } = useStore();
//   const [getAgents] = useAxios<AgentListResponse>({ endpoint: "GETAGENTLIST", hideErrorMsg: true });
//   const [createAgent, , creating] = useAxios({ endpoint: "CREATEAGENT", showSuccessMsg: true });
...
export default function BotsPage() {
  ...
  // FIXED: State lazy-initialized to eliminate synchronous setState loops inside useEffect
  ...
  // FIXED: Removed the synchronous state update here
  useEffect(() => {
    refreshAgents();
    getAgents(undefined, (payload) => {
